...
/*
Interface Found. TargetType: IEditObjectList ConcreteType: EditObjectList
Class: Neatoo.UnitTest.SystemTextJson.EditTests.EditObjectList Name: EditObjectList
...
namespace Neatoo.UnitTest.SystemTextJson.EditTests
{
    ...
    internal class EditObjectListFactory : FactoryBase<IEditObjectList>, IEditObjectListFactory
    {
        private readonly IServiceProvider ServiceProvider;
        private readonly IMakeRemoteDelegateRequest? MakeRemoteDelegateRequest;
        // Delegates
        // Delegate Properties to provide Local or Remote fork in execution
        public EditObjectListFactory(IServiceProvider serviceProvider, IFactoryCore<IEditObjectList> factoryCore) : base(factoryCore)
        {
            this.ServiceProvider = serviceProvider;
        }

        public EditObjectListFactory(IServiceProvider serviceProvider, IMakeRemoteDelegateRequest remoteMethodDelegate, IFactoryCore<IEditObjectList> factoryCore) : base(factoryCore)
        {
            this.ServiceProvider = serviceProvider;
